...
CREATE TABLE `parto` (
  ...
  `peso_matriz_pre_parto` decimal(5,2) DEFAULT NULL,
  `peso_matriz_pos_parto` decimal(5,2) DEFAULT NULL,
  `peso_nasc1` decimal(5,2) DEFAULT NULL,
  `estado_nasc1` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame1` decimal(5,2) DEFAULT NULL,
  `peso_nasc2` decimal(5,2) DEFAULT NULL,
  `estado_nasc2` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame2` decimal(5,2) DEFAULT NULL,
  `peso_nasc3` decimal(5,2) DEFAULT NULL,
  `estado_nasc3` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame3` decimal(5,2) DEFAULT NULL,
  `peso_nasc4` decimal(5,2) DEFAULT NULL,
  `estado_nasc4` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame4` decimal(5,2) DEFAULT NULL,
  `peso_nasc5` decimal(5,2) DEFAULT NULL,
  `estado_nasc5` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame5` decimal(5,2) DEFAULT NULL,
  `peso_nasc6` decimal(5,2) DEFAULT NULL,
  `estado_nasc6` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame6` decimal(5,2) DEFAULT NULL,
  `peso_nasc7` decimal(5,2) DEFAULT NULL,
  `estado_nasc7` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame7` decimal(5,2) DEFAULT NULL,
  `peso_nasc8` decimal(5,2) DEFAULT NULL,
  `estado_nasc8` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame8` decimal(5,2) DEFAULT NULL,
  `peso_nasc9` decimal(5,2) DEFAULT NULL,
  `estado_nasc9` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame9` decimal(5,2) DEFAULT NULL,
  `peso_nasc10` decimal(5,2) DEFAULT NULL,
  `estado_nasc10` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame10` decimal(5,2) DEFAULT NULL,
  `peso_nasc11` decimal(5,2) DEFAULT NULL,
  `estado_nasc11` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame11` decimal(5,2) DEFAULT NULL,
  `peso_nasc12` decimal(5,2) DEFAULT NULL,
  `estado_nasc12` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame12` decimal(5,2) DEFAULT NULL,
  `peso_nasc13` decimal(5,2) DEFAULT NULL,
  `estado_nasc13` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame13` decimal(5,2) DEFAULT NULL,
  `peso_nasc14` decimal(5,2) DEFAULT NULL,
  `estado_nasc14` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame14` decimal(5,2) DEFAULT NULL,
  `peso_nasc15` decimal(5,2) DEFAULT NULL,
  `estado_nasc15` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame15` decimal(5,2) DEFAULT NULL,
  `peso_nasc16` decimal(5,2) DEFAULT NULL,
  `estado_nasc16` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame16` decimal(5,2) DEFAULT NULL,
  `peso_nasc17` decimal(5,2) DEFAULT NULL,
  `estado_nasc17` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame17` decimal(5,2) DEFAULT NULL,
  `peso_nasc18` decimal(5,2) DEFAULT NULL,
  `estado_nasc18` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame18` decimal(5,2) DEFAULT NULL,
  `peso_nasc19` decimal(5,2) DEFAULT NULL,
  `estado_nasc19` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame19` decimal(5,2) DEFAULT NULL,
  `peso_nasc20` decimal(5,2) DEFAULT NULL,
  `estado_nasc20` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame20` decimal(5,2) DEFAULT NULL,
  `peso_nasc21` decimal(5,2) DEFAULT NULL,
  `estado_nasc21` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame21` decimal(5,2) DEFAULT NULL,
  `peso_nasc22` decimal(5,2) DEFAULT NULL,
  `estado_nasc22` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame22` decimal(5,2) DEFAULT NULL,
  `peso_nasc23` decimal(5,2) DEFAULT NULL,
  `estado_nasc23` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame23` decimal(5,2) DEFAULT NULL,
  `peso_nasc24` decimal(5,2) DEFAULT NULL,
  `estado_nasc24` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame24` decimal(5,2) DEFAULT NULL,
  `peso_nasc25` decimal(5,2) DEFAULT NULL,
  `estado_nasc25` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame25` decimal(5,2) DEFAULT NULL,
  `peso_nasc26` decimal(5,2) DEFAULT NULL,
  `estado_nasc26` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame26` decimal(5,2) DEFAULT NULL,
  `peso_nasc27` decimal(5,2) DEFAULT NULL,
  `estado_nasc27` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame27` decimal(5,2) DEFAULT NULL,
  `peso_nasc28` decimal(5,2) DEFAULT NULL,
  `estado_nasc28` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame28` decimal(5,2) DEFAULT NULL,
  `peso_nasc29` decimal(5,2) DEFAULT NULL,
  `estado_nasc29` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame29` decimal(5,2) DEFAULT NULL,
  `peso_nasc30` decimal(5,2) DEFAULT NULL,
  `estado_nasc30` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame30` decimal(5,2) DEFAULT NULL,
  `peso_nasc31` decimal(5,2) DEFAULT NULL,
  `estado_nasc31` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame31` decimal(5,2) DEFAULT NULL,
  `peso_nasc32` decimal(5,2) DEFAULT NULL,
  `estado_nasc32` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame32` decimal(5,2) DEFAULT NULL,
  `peso_nasc33` decimal(5,2) DEFAULT NULL,
  `estado_nasc33` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame33` decimal(5,2) DEFAULT NULL,
  `peso_nasc34` decimal(5,2) DEFAULT NULL,
  `estado_nasc34` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame34` decimal(5,2) DEFAULT NULL,
  `peso_nasc35` decimal(5,2) DEFAULT NULL,
  `estado_nasc35` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame35` decimal(5,2) DEFAULT NULL,
  `peso_nasc36` decimal(5,2) DEFAULT NULL,
  `estado_nasc36` varchar(1) COLLATE utf8_swedish_ci DEFAULT NULL,
  `peso_desmame36` decimal(5,2) DEFAULT NULL,
...
CREATE TABLE `reprodutor` (
  ...
  `peso_nasc` decimal(5,2) DEFAULT NULL,
  `data_chegada` date DEFAULT NULL,
  `peso_chegada` decimal(5,2) DEFAULT NULL,
